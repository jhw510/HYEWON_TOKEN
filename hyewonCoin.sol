...
contract HyewonCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HyewonCoin() {
        ...
        name = "hyewonCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "HYEWON";                                             // Set the symbol for display purposes (CHANGE THIS)
